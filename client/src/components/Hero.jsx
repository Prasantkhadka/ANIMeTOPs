...
const Hero = () => {
  return (
    <section className="max-padd-container bg-hero bg-contain bg-center bg-no-repeat w-full min-h-[600px] sm:min-h-[700px] md:min-h-[800px] flex items-center justify-center sm:justify-start px-4 sm:px-10 md:px-20">
      <div className="flex flex-col h-full justify-center items-start max-w-[777px] pt-8">
        <h1 className="h1 max-w-[699px] font-[800] leading-none uppercase text-3xl sm:text-5xl md:text-6xl lg:text-7xl">
        ...
        <Link
          to="/collection"
          className="inline-flex bg-tertiary text-white flexCenter p-5 w-52 mt-8 bold-20 sm:text-lg rounded-none "
        >
          Shop Now
        </Link>
      </div>
