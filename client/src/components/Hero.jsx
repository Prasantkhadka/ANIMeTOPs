...
const Hero = () => {
  return (
    <section className="max-padd-container bg-hero bg-cover bg-center bg-no-repeat h-[70vh] w-full sm:h-[80vh] md:h-[90vh] lg:h-[811px] flex items-center justify-center sm:justify-start px-4 sm:px-10 md:px-20">
