...
const Hero = () => {
  return (
    <section className="bg-hero bg-contain bg-center bg-no-repeat w-full min-h-[600px] sm:min-h-[700px] md:min-h-[800px] flex items-center justify-center sm:justify-start px-4 sm:px-10 md:px-20">
